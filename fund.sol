...
contract FundMe{
    ...
    require (msg.value>1e10,"Dont fulfill the minimum");
       
          address _id=msg.sender;
           adv[_id]+=msg.value;                               // store the address with value in adv mapping
           uint flag=0;
      ...
      function owntranfer(address _owner) public owne{        //only oner can tranfer ownership
           owner=_owner;
      }
}
